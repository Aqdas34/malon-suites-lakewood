...
const Suites = () => {
  ...
  if (loading) return <div className="pt-[200px] text-center font-forum text-2xl">Preparing your suites...</div>;
      ...
      <section className="max-w-[1440px] mx-auto px-6 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {suites.map((suite) => {
            ...
            const mainImg = images[0] || "/assets/images/SEV05322.jpg";
              ...
              >
                ...
                <div className="p-10 text-center flex flex-col items-center">
                  ...
                  <p className="text-[#967D52] text-[18px] mb-10 font-forum font-bold tracking-widest">
                    Starting at: <span className="text-[22px]">${suite.base_price}</span> / NIGHT
                  </p>
                  <Link 
